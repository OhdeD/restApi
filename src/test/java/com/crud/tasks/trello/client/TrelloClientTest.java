...
public class TrelloClientTest {
    ...
    public void init(){
        ...
        when(trelloConfig.getUsername()).thenReturn("dagmaraohde");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/dagmaraohde/boards?key=test&token=test&fields=name,id&lists=all");
